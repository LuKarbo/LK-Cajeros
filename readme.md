...
# LK-Cajeros
LK-Cajeros es un proyecto creado para la materia Programación Avanzada de la Facultad Da Vinci. El objetivo principal de este proyecto es simular el funcionamiento de cajeros automáticos.
...
- `Facade/`: Contiene codigo vario sobre creacion de tablas, lista, verificaciones.
